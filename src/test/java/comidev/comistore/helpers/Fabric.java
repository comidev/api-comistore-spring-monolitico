...
public class Fabric {
    ...
    public User createUser(String username, String password) {
        String usernameDB = username != null ? username : random();
        String passwordDB = password != null ? bcrypt.encode(password) : "comidev123";
        return userRepo.save(new User(null, usernameDB, passwordDB, null));
    }
    ...
    public InvoiceItem createInvoiceItem(Product product) {
        ...
        return invoiceItemRepo.save(new InvoiceItem(null,3, productDB));
    }
